...
I used CSS for animations and styling, and JS/JQuery functioned as the backend to retrieve the data in a timly interval.
...
Given more time, I definitely would've used a more extensible library such as ReactJS. Further more, I could've 
implemented the additional information to each node in the grid. 
